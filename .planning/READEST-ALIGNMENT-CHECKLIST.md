...
- [x] P5-1.8 Let the AI workspace clear current-book archived history by mode
  ...
  - Tutorial: `tutorials/commit/0568-let-the-ai-workspace-clear-current-book-history.md`.
  - Notes: this slice keeps clearing scoped to the current book and the active notebook mode. It also fixes the assistance history/selection persistence reactive wiring so cleared notebook lanes actually propagate back into local storage.
