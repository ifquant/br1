...
| 648 | `aab58241d` | reader core | feat(reader): jump from a footnote popup to the location in the book (#5889) | `partial` | S2-R04C7 | Core reading exists; this authored-layout/script edge is unverified. |
