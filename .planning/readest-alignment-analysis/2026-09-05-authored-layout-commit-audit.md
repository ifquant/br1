...
| **S2-R04C13A-C13C** | Warichu/Gezhu locator compatibility, then measured layout | `ebbbf104b` | C13A evidence and B1/B2a/B2b note, bookmark and library progress provenance precede remaining writers and B3 compatibility/restore protection. C13C DOM/layout waits; parent remains partial. |
...
the remaining **S2-R04C13B2** writer scope freeze, after C13A evidence and B1/B2a/B2b
note, bookmark and library progress provenance. C12 is complete at the host owner with 97 browser
...
the C13B/C13C gates. [B1/B2a/B2b evidence and remaining obligations](./2026-09-06-warichu-historical-locators.md)
separate note/bookmark/progress provenance and bookmark load protection from historical
