...
- after exit, the smoke clears the live EPUB selection, moves reading progress, reloads the same book, and confirms both the overlay and the live Foliate DOM selection stay gone until the reader manually reopens paragraph focus from the menu
